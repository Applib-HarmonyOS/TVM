...
public class Device {
  ...
  private static final String GET_DEVICE_ATTR = "_GetDeviceAttr";
  ...
  public boolean exist() {
    TVMValue ret = APIInternal.get(GET_DEVICE_ATTR)
  ...
  @Override public String toString() {
    // Below variable is temperoray hack, as currently RPC support is disabled
    // Once RPC support added, we can remove below var dependency
    // and use directly RPC.RPC_SESS_MASK.
    int RPC_SESS_MASK = 128;
